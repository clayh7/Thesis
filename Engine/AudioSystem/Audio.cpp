...
//---------------------------------------------------------------------------
SoundID BAudio::CreateOrGetSound( std::string const & soundFileName )
{
...
//---------------------------------------------------------------------------
AudioChannelHandle BAudio::PlayAudio( SoundID soundID, float volumeLevel /*= 1.f*/, bool looping /*= false*/ )
{
...
//---------------------------------------------------------------------------
void BAudio::StopChannel( AudioChannelHandle channel )
{
	if ( channel != nullptr )
	{
...
//---------------------------------------------------------------------------
void BAudio::ValidateResult( FMOD_RESULT result )
{
	if( result != FMOD_OK )
	{
